...
const char* font_manager_measure(struct font_manager *F, int fontid, int codepoint, int size, struct font_glyph *g);
const char* font_manager_atlas_glyph(struct font_manager *F, int fontid, int codepoint, int size, struct font_glyph *g, struct font_glyph *og);
